...
async function main() {
    ...
    while (true) {
        try {
            ...
            await sc.page.waitForFunction(() => document.body.innerText.includes("Finding next task") || !document.querySelector('img[alt="Option A"]'), { timeout: 15000 }).catch(() => { });
        }
        catch (err) {
